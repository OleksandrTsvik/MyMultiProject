...
namespace Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "user_permission_user_role",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_permission_user_role", x => new { x.permissions_id, x.roles_id });
                    table.ForeignKey(
                        name: "fk_user_permission_user_role_user_permissions_permissions_id",
                        column: x => x.permissions_id,
                        principalTable: "user_permissions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_permission_user_role_user_roles_roles_id",
                        column: x => x.roles_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    full_name = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_birthdays_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_permission_user_role_roles_id",
                table: "user_permission_user_role",
                column: "roles_id");

            migrationBuilder.CreateIndex(
                name: "ix_user_permissions_name",
